...
adminRoute
  .route("/user/users")
  .get(asyncHandler(adminController.getUsersForUser));

adminRoute.route("/users").post(asyncHandler(adminController.createUser));
adminRoute
  .route("/users/bulk")
  .post(asyncHandler(adminController.createUserBulk));
adminRoute
  .route("/users/:userId")
...
adminRoute
  .route("/users/:membership_id")
  .delete(asyncHandler(adminController.deleteUser));
adminRoute
  .route("/users/suspend/:userId")
  .put(asyncHandler(adminController.suspendUser));
