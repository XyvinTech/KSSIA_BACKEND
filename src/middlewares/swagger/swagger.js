      ...
      schemas: {
        ...
        Notification: {
          ...
          properties: {
            ...
            type: {
              type: 'boolean',
              description: 'Type of notification (false for email, true for in-app)'
            },
            sent_status: {
              type: 'boolean',
              description: 'Status of whether the email has been sent'
            },
            sent_at: {
              type: 'string',
              format: 'date-time',
            ...
            recived_status: {
              type: 'boolean',
              description: 'Status of whether the notification has been received'
            },
            read_status: {
              type: 'boolean',
              description: 'Status of whether the notification has been read'
            },
            createdAt: {
              type: 'string',
              format: 'date-time',
